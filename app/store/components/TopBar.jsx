...
const TopBar = ({ total, searchTerm, setSearchTerm }) => {
  return (
    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
      <h1 className="text-2xl font-semibold text-gray-300">Store Management</h1>
      <div className="flex flex-wrap items-center gap-8">
        ...
        <p className="text-gray-400 text-sm">Total Stores: {total}</p>
